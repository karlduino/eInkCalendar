...
for(file in files) {
   ...
   system("convert tmp2.bmp -background white -gravity southwest -splice 375x415 tmp3.bmp")

   system("convert tmp3.bmp tmp4.bmp -gravity northwest -geometry 25x25+320+40 -composite tmp6.bmp")
   system(paste("convert tmp6.bmp tmp5.bmp -gravity northwest -geometry 25x25+410+40 -composite", file.path(odir, file)))
}
