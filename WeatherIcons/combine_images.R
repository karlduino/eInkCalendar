...
for(file in files) {
   ...
   # fill out to 800x480
   system("convert tmp1.bmp -background white -gravity northeast -splice 372x0 tmp2.bmp")
   system("convert tmp2.bmp -background white -gravity southwest -splice 372x424 tmp3.bmp")

   # merge in sunrise/sunset icons
   system("convert tmp3.bmp tmp4.bmp -gravity northwest -geometry 25x25+320+48 -composite tmp6.bmp")
   system(paste("convert tmp6.bmp tmp5.bmp -gravity northwest -geometry 25x25+410+48 -composite tmp7.bmp"))
